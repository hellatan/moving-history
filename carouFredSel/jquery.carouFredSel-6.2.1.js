...
(function($) {
    ...
    function sz_setResponsiveSizes(o, all) {
        ...
        // GEDAS - IMPROVEMENT - MOVED FROM EACH LOOP TO COUNT JUST FIRST ELEMENT DIMENSIONS
            padd = ms_getPaddingBorderMargin($(all[0]), o, 'Width');
        ...
        all.each(function() {
            ...
            if (secp  && !(o.direction == 'up' || o.direction == 'down'))
            {
